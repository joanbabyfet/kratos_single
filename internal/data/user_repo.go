...
//构造函数注入
func NewUserRepo(data *Data, rdb *redis.Client, logger log.Logger) biz.UserRepo {
	return &userRepo{
		data: data,
		rdb: rdb,
...
// 获取列表
func (r *userRepo) List(ctx context.Context, q *biz.UserQuery) ([]*biz.User, int64, error) {
	...
	if q.Phone != "" {
		db = db.Where("title LIKE ?", "%"+q.Phone+"%")
	}
...
// 获取详情
func (r *userRepo) GetById(ctx context.Context, id string, useCache bool) (*biz.User, error) {
...
// 添加
func (r *userRepo) Create(ctx context.Context, a *biz.User) (string, error) {
...
// 修改, 一律删除缓存（统一处理）
func (r *userRepo) Update(ctx context.Context, a *biz.User, lockMode string) error {
...
//更新登录信息
func (r *userRepo) UpdateLogin(ctx context.Context, id string, ip string) error {
...
func (r *userRepo) Delete(ctx context.Context, id string, user string) error {
...
//获取详情缓存键
func KeyUserDetail(id string) string {
